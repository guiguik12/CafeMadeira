...
class Canvas {
  ...
  addEventListeners() {
    ...
    container.addEventListener('mousedown', this.onTouchDown);
    container.addEventListener('mousemove', this.onTouchMove);
    container.addEventListener('mouseup', this.onTouchUp);
    container.addEventListener('touchstart', this.onTouchDown as EventListener);
    container.addEventListener('touchmove', this.onTouchMove as EventListener);
    container.addEventListener('touchend', this.onTouchUp as EventListener);
  ...
  destroy() {
    ...
    container.removeEventListener('mousedown', this.onTouchDown);
    container.removeEventListener('mousemove', this.onTouchMove);
    container.removeEventListener('mouseup', this.onTouchUp);
    ...
    container.removeEventListener('touchend', this.onTouchUp as EventListener);
